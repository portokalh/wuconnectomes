...
inputs="${outpath}/${job_desc}_${runno}_m${zeros}-inputs/";
work="${outpath}/${job_desc}_${runno}_m${zeros}-work/";
results="${outpath}/${job_desc}_${runno}_m${zeros}-results/";
...
prefix="${outpath}/${job_desc}_${runno}_m${zeros}-inputs/${runno}_m.nii.gz";
