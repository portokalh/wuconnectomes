...
l = ['N54717', 'N54718', 'N54876', 'N54877', 'N54879', 'N54880','N54760', 'N54824', 'N54826', 'N54837', 'N54838', 'N54856', 'N54857',
...
function_processes = np.int(mp.cpu_count()/function_processes)
...
savefig=False
doprune=True
strproperty = "_zflip_affine0_all"
...
if subject_processes>1:
    if function_processes>1:
        ...
        tract_results = pool.starmap_async(create_tracts, [(dwipath, outtrkpath, subject, stepsize, function_processes, strproperty,
                                                                saved_streamlines, savefa, labellist, verbose) for subject in
                                                               l]).get()
    ...
    for subject in l:
        tract_results.append(create_tracts(dwipath, outtrkpath, subject, stepsize, function_processes, strproperty,
                                                                                         saved_streamlines, savefa, labellist, verbose))
