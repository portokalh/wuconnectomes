...
streamlines_list_path = "/Volumes/Data/Badea/Lab/mouse/C57_JS/VBM_whiston_Figs_inclusive/" + subj + "_stepsize_2_ratio_100_wholebrain_grouping.xlsx"
...
if not path.exists(tract_newpath):
    trkstreamlines, affine = reducetractnumber(tract_path, tract_newpath, getdata=True, ratio=1, return_affine=True,
                                               verbose=False)
else:
